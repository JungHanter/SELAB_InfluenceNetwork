...
document.onload = (function(d3, saveAs, Blob, undefined){
    ...
    var GraphCreator = function(svg, nodes, edges, nodeTypes, edgeTypes){
        ...
        defs.append('svg:marker')
            .attr('style', 'fill : #5ec4cc;')
            .attr('id', 'end-arrow-selected-hover')
            .attr('viewBox', '-1 -5 10 10')
            .attr('refX', "32")
            .attr('markerWidth', 3.5)
            .attr('markerHeight', 3.5)
        ...
        function appendMarker(defs) {
            colors.forEach(function (color) {
                ...
                defs.append('svg:marker')
                    .attr('style', 'fill : ' + color.normal)
                    .attr('id', 'end-arrow-selected-' + color.name)
                    .attr('viewBox', '-1 -5 10 10')
                    .attr('refX', "32")
                    .attr('markerWidth', 3.5)
                    .attr('markerHeight', 3.5)
                ...
                defs.append('svg:marker')
                    .attr('style', 'fill : ' + color.hover)
                    .attr('id', 'end-arrow-selected-hover-' + color.name)
                    .attr('viewBox', '-1 -5 10 10')
                    .attr('refX', "32")
                    .attr('markerWidth', 3.5)
                    .attr('markerHeight', 3.5)
